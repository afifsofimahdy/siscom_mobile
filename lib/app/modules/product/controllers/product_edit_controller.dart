...
class ProductEditController extends GetxController {
  ...
  void initializeData() {
    ...
    imageController.text = productData.imageUrl;
    selectedGroupItem.value = productData.groupItem;
    ...
    if (formKey.currentState!.validate()) {
      try {
        ...
        final updatedProduct = Product(
          id: productData.id, // Preserve the original ID
        ...
        await productRepository.updateProduct(productData.id.toString(),updatedProduct);
